...
public class LED extends SubsystemBase {
  ...
  private TargetVision m_photoncam = new TargetVision();
  private final AddressableLED m_led = new AddressableLED(9);
  private final AddressableLEDBuffer m_ledBuffer = new AddressableLEDBuffer(9);
