...
public class RotateIntakeToAngle extends Command {
    ...
    public void initialize() {
        this.kDirection = this.m_intake.getRotationAbsolutePosition() > kPosition
    ...
    public void execute() {
        ...
        if (Math.abs(this.m_intake.getRotationAbsolutePosition() - kPosition) <= 0.05 && !this.slowed) {
    ...
    public boolean isFinished() {
        return Math.abs(this.m_intake.getRotationAbsolutePosition() - kPosition) <= 0.005;
    }
